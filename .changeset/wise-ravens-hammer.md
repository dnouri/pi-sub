...
- On model selection, sub-core now performs a fetch instead of only skipped warm-up calls, preventing initial empty Spark usage on startup.
- When a Spark model is active, Codex is displayed as **Codex (Spark)** in the usage bar provider label.
